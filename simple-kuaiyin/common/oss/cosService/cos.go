...
func (cosOss *CosService) GetClient() (interface{}, error) {
	...
	once.Do(func() {
		...
		//	},
		//})
		u, _ := url.Parse("https://defeng-1253648317.cos.ap-beijing.myqcloud.com")
		b := &cos.BaseURL{BucketURL: u}
		client = cos.NewClient(b, &http.Client{
			Transport: &cos.AuthorizationTransport{
				// 通过环境变量获取密钥
				// 环境变量 SECRETID 表示用户的 SecretId，登录访问管理控制台查看密钥，https://console.cloud.tencent.com/cam/capi
				SecretID: "AKID37H0dPFJXeaN4gNTVUL6uiZJPh1RwT3f",
				// 环境变量 SECRETKEY 表示用户的 SecretKey，登录访问管理控制台查看密钥，https://console.cloud.tencent.com/cam/capi
				SecretKey: "fFgJ0bAd2PnJj3FKJ8z4KZCxhMqFarce",
			},
		})
